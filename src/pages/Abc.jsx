  ...
  if (mediaType === 'movie') {
    return (
      ...
      <div className="w-full flex flex-wrap">
        <h1 className='text-white text-3xl font-bold m-3'>{media.title}</h1>
      <iframe
        ...
        allowFullScreen
      ></iframe>
      <div className="flex justify-center gap-5 items-center w-full mt-1">
        <span
      ...
      <div className="rounded-lg w-1/3 bg-gray-400 p-3 mt-5">
  ...
  if (mediaType === 'tv') {
    return (
      <div className="flex flex-col">
        ...
        <div className="flex mt-14 relative w-full">
          <div className="w-full flex flex-wrap">
            <h1 className='text-white text-3xl font-bold m-3'>{`${media.name}: S${currentSeason}:E${currentEpisode}`}</h1>
            <iframe
              className="w-full h-96 rounded-xl mx-3"
              src={tvIframeUrl}
              style={{ border: 'none' }}
              title="TV Show Player"
              allowFullScreen
            ></iframe>
            <div className="flex justify-center gap-5 items-center w-full mt-2">
              <span
              ...
              <span
                onClick={() => setTvIframeUrl(`https://vidsrc.xyz/embed/tv?imdb=${media.id}&season=${currentSeason}&episode=${currentEpisode}`)}
                className="text-lg bg-red-300 p-2 px-3 rounded-3xl cursor-pointer hover:bg-red-400"
              >
                Server 2
              </span>
          ...
          <div style={{ height: '24rem' }} className="rounded-lg w-1/3 overflow-y-auto bg-gray-400 p-3">
